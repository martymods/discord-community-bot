    ...
    try {
      ...
      for (const game of games) {
        ...
        const embed = new EmbedBuilder()
          ...
          .setFooter({ text: 'Dreamworld Sports Analytics • Real-Time NBA Model' })
          .setColor(predicted === home ? '#00cc88' : '#3399ff')
          .setTimestamp();
        ...
        const q1Pick = (homeStats.pointsPerGame + awayStats.pointsPerGame) / 2 > 112
          ? '🕒 1st Q Over 56.5' : '🧊 1st Q Under 56.5';
      ...
      return message.reply('⚠️ Something went wrong predicting NBA matchups.');
    }
  }
});
